...
<body>
   <div id='board'>
      ...
      <form name='frm_board' class='frm_board' id='frm_board' method='post'>
         ...
         <div class='btns'>
            <button type='button' class='btnModify' onclick='board.modify(this.form)'>수정</button>
            <button type='button' class='btnDelete' onclick='board.deleteR(this.form)'>삭제</button>
            <button type='button' class='btnRepl' onclick='board.repl(this.form)'>답글</button>
